...
[<img src="https://github.com/jivoi/awesome-osint/raw/master/osint_logo.png" align="right" width="100">](https://github.com/jivoi/awesome-osint) ⭐ 29,628 | 🐛 27 | 📅 2026-09-09
...
* [AtDork](https://github.com/amnottdevv/atdork) ⭐ 39 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - Professional OSINT dorking tool featuring adaptive delay, circuit breaker, and automatic backend fallback to avoid IP bans and rate limits.
...
* [NOX](https://github.com/nox-project/nox-framework) ⭐ 326 | 🐛 1 | 🌐 Python | 📅 2026-05-06 - Recursive async framework for deep breach analysis and identity pivoting.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,454 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram offers an interactive shell to perform analysis on Instagram account of any users by its nickname.
* [Toutatis](https://github.com/megadose/toutatis) ⭐ 4,295 | 🐛 347 | 🌐 Python | 📅 2024-12-05 - a tool that allows you to extract information from instagrams accounts such as s, phone numbers and more
* [instagram\_monitor](https://github.com/misiektoja/instagram_monitor) ⭐ 1,505 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - Tool for real-time tracking of Instagram users' activities and profile changes with support for email alerts, CSV logging, showing media in the terminal, anonymous story downloads and more
* [InstagramPrivSniffer](https://github.com/obitouka/InstagramPrivSniffer) ⭐ 1,014 | 🐛 5 | 🌐 Python | 📅 2026-09-18 - Views Instagram PRIVATE ACCOUNT'S media without login 😱.
* [Osintgraph](https://github.com/XD-MHLOO/Osintgraph) ⭐ 957 | 🐛 11 | 🌐 Python | 📅 2026-05-10 - Tool that maps your target’s Instagram data and relationships in Neo4j for social network analysis.
* [insto](https://github.com/subzeroid/insto) ⭐ 115 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Interactive OSINT CLI / REPL with 35+ slash-commands: profile + media + followers + dossier + geo-fingerprint (`/where`), shared-followers intersection (`/intersect`), superfan ranking (`/fans`), location search (`/place`), URL→metadata resolution (`/postinfo`), posting-cadence histogram (`/timeline`), Maltego CSV export. Token-based (HikerAPI, no IG account needed → no ban risk) with optional logged-in `aiograpi` backend.
...
* [Arctic Shift](https://github.com/ArthurHeitmann/arctic_shift) ⭐ 1,534 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-12 - A tool for accessing and interacting with large dumps of Reddit data, offering an API and web interface for research and moderation purposes.
...
* [LinkedInDumper](https://github.com/l4rm4nd/LinkedInDumper) ⭐ 613 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - Script to dump/scrape/extract company employees info from LinkedIn API.
...
* [Telerecon](https://github.com/sockysec/Telerecon) ⭐ 1,327 | 🐛 6 | 🌐 Python | 📅 2024-07-11 - A reconnaissance framework for researching and investigating Telegram.
* [Telepahty](https://github.com/proseltd/Telepathy-Community) ⭐ 1,236 | 🐛 48 | 🌐 Python | 📅 2026-08-13 - Telepathy is a tool that archives Telegram chats and analyzes communication patterns within the app. By providing insights into user interactions, message frequency, and content trends, Telepathy helps investigators understand the dynamics and relationships within Telegram groups and channels.
* [Telegram Nearby Map](https://github.com/tejado/telegram-nearby-map) ⭐ 1,192 | 🐛 10 | 🌐 JavaScript | 📅 2024-02-17 - Webapp based on OpenStreetMap and the official Telegram library to find the position of nearby users.
* [TOsint](https://github.com/drego85/tosint) ⭐ 851 | 🐛 0 | 🌐 Python | 📅 2026-07-29 - Tosint (Telegram OSINT) is a powerful tool designed to extract valuable information from Telegram bots and channels. It serves as an essential resource for security researchers, investigators, and anyone interested in gathering insights from various Telegram entities.
...
* [Telegram channels scraper TeleGraphite ](https://github.com/hamodywe/telegram-scraper-TeleGraphite) ⭐ 290 | 🐛 1 | 🌐 Python | 📅 2026-08-11 - Telegram Scraper & JSON Exporter & telegram channels scraper.
...
* [OSINT-Steam](https://osint-steam.vercel.app/en) - An [open-source](https://github.com/Berchez/OSINT-steam) ⭐ 27 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-17 tool that returns public information, such as friends list and possible locations, from Steam profiles.

### [↑](#-table-of-contents) GitHub

* [Shotstars](https://github.com/snooppr/shotstars) ⭐ 118 | 🐛 1 | 🌐 Python | 📅 2026-06-04 - An advanced tool for checking GitHub repositories, with star statistics, including fake star analysis and data visualization.
* [github\_monitor](https://github.com/misiektoja/github_monitor) ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of GitHub users' activities including profile and repository changes with support for email alerts, CSV logging, detection when a user blocks or unblocks you and more
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,080 | 🐛 348 | 🌐 Python | 📅 2026-09-19 - Search for a username in multiple platforms/websites.
* [Maigret](https://github.com/soxoj/maigret) ⭐ 37,783 | 🐛 64 | 🌐 Python | 📅 2026-09-18 - Collect a dossier on a person by username.
* [Social Analyzer](https://github.com/qeeqbox/social-analyzer) ⭐ 24,064 | 🐛 28 | 🌐 JavaScript | 📅 2026-01-12 - API, CLI, and Web App for analyzing and finding a person's profile in 1000 social media \ websites
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,446 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search a username across over 600+ websites.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,852 | 🐛 9 | 🌐 Python | 📅 2026-09-18 — Check a username's presence across dev/social/gaming/creator site
* [Snoop](https://github.com/snooppr/snoop/blob/master/README.en.md) ⭐ 4,031 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Search for a nickname on the web (OSINT world)
* [NexFil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,620 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - checks username from almost all social network sites.
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 875 | 🐛 65 | 🌐 Go | 📅 2026-06-16 A multi-purpose all in one toolkit for gathering and managing OSINT-Data with a neat web-interface. Can be used for note taking and username checking.
* [Cupidcr4wl](https://github.com/OSINTI4L/cupidcr4wl) ⭐ 173 | 🐛 0 | 🌐 Python | 📅 2026-07-16 - Username and phone number search tool that crawls adult content platforms to see if a targeted account or person is present.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,577 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Investigate Google emails and documents.
* [Holehe](https://github.com/megadose/holehe) ⭐ 14,939 | 🐛 118 | 🌐 Python | 📅 2024-09-10 - allows you to check if the mail is used on different sites like twitter, instagram and will retrieve information on sites with the forgotten password function.
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,446 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search for accounts associated with a given email across various platforms.
* [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,308 | 🐛 39 | 🌐 Python | 📅 2023-08-15 - Password Breach Hunting and Email OSINT, locally or using premium services. Supports chasing down related email.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,852 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,404 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Free email OSINT tool, checks 800+ platforms, breach exposure via HIBP, infostealer logs via Hudson Rock, and builds a cross-platform identity graph with confidence scoring. `pip install mailaccess`
...
* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,911 | 🐛 146 | 🌐 Go | 📅 2026-08-25 - Advanced information gathering & OSINT framework for phone numbers.
...
* [Crypto Scam & Crypto Phishing URL Threat Intel Feed](https://github.com/spmedia/Crypto-Scam-and-Crypto-Phishing-Threat-Intel-Feed) ⭐ 70 | 🐛 1 | 📅 2026-09-18 - A fresh feed of crypto phishing and crypto scam websites. Automatically updated daily.
...
* [Domain Hunter](https://github.com/WhiteBite/Domain-Hunter) ⭐ 18 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - Free, open-source, 100% client-side bulk domain availability checker and name generator: checks up to 3,000 names across 148 TLD zones by calling registry RDAP endpoints directly from the browser (no servers, no API keys, no tracking), with DNS-over-HTTPS corroboration for low-trust ccTLDs, live registrar prices with 3-year TCO, and CSV/Markdown export. MIT. ([live demo](https://whitebite.github.io/Domain-Hunter/))
...
* [Wayback Machine Archiver](https://github.com/jsvine/waybackpack) ⭐ 3,231 | 🐛 32 | 🌐 Python | 📅 2025-04-21
* [waybackpy](https://github.com/akamhy/waybackpy) ⭐ 605 | 🐛 23 | 🌐 Python | 📅 2024-02-26 - Python package & CLI tool that interfaces the Wayback Machine APIs.
* [Wayback-Archive](https://github.com/GeiserX/Wayback-Archive) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Download complete websites from the Wayback Machine with full asset preservation for offline viewing.
...
* see the [Awesome Translations list](https://github.com/mbiesiad/awesome-translations#tools) ⭐ 193 | 🐛 18 | 📅 2026-01-18

## [↑](#-table-of-contents) Image Search

* [GeoSpyer](https://github.com/atiilla/geospy "Original service: https://geospy.web.app/") ⭐ 1,138 | 🐛 2 | 🌐 HTML | 📅 2026-03-09 - Python tool using Graylark's AI-powered geo-location service to uncover the location where photos were taken.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp/) ⭐ 192,071 | 🐛 2,659 | 🌐 Python | 📅 2026-09-16 - Downloads videos from almost any online platform, along with information, thumbnails, subtitles, descriptions, and comments (comments only on a select few sites like Youtube and a few small sites). If a site is not supported, or a useful or crucial piece of metadata, including comments, is missing, create an issue.
...
* [Hyperlapse](https://github.com/TeehanLax/Hyperlapse.js) ⭐ 2,464 | 🐛 27 | 🌐 JavaScript | 📅 2020-02-29
...
* [ChangeDetection.io Open Source](https://github.com/dgtlmoon/changedetection.io) ⭐ 34,348 | 🐛 380 | 🌐 Python | 📅 2026-09-19
* [Website-Diff](https://github.com/GeiserX/Website-Diff) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-14
...
* [Perspective](https://github.com/finos/perspective) ⭐ 11,230 | 🐛 36 | 🌐 Rust | 📅 2026-09-18 - interactive data visualization and analytics component, well-suited for large, streaming and static datasets.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,408 | 🐛 44 | 🌐 Python | 📅 2026-09-17
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 67,963 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-18
* [MetaClean](https://github.com/Moresyl/metaclean) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Cross-platform desktop app for removing sensitive metadata from files locally before sharing them during OSINT investigations.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,189 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - The amass tool searches Internet data sources, performs brute force subdomain enumeration, searches web archives, and uses machine learning to generate additional subdomain name guesses. DNS name resolution is performed across many public servers so the authoritative server will see the traffic coming from different locations. Written in Go.
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,878 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - A fast and multi-purpose DNS toolkit from ProjectDiscovery for running DNS probes, resolving records and filtering DNS responses.
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,379 | 🐛 319 | 🌐 Python | 📅 2026-04-13 - SpiderFoot Github repository.
* [The Harvester](https://github.com/laramies/theHarvester) ⭐ 17,542 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - Gather emails, subdomains, hosts, employee names, open ports and banners from different public sources like search engines, PGP key servers and SHODAN computer database.
* [CrowdSec](https://github.com/crowdsecurity/crowdsec) ⭐ 14,899 | 🐛 295 | 🌐 Go | 📅 2026-09-18 - An open source, free, and collaborative IPS/IDS software written in Go, able to analyze visitor behavior & provide an adapted response to all kinds of attacks.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,209 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Crawler designed for OSINT
* [ReconFTW](https://github.com/six2dez/reconftw) ⭐ 8,124 | 🐛 7 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance framework for bug bounty and pentesting with multiple integrated tools.
* [Waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,563 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all URLs known by the Wayback Machine for a domain.
...
* [Datasploit](https://github.com/DataSploit/datasploit) ⭐ 3,313 | 🐛 107 | 🌐 Python | 📅 2025-11-20 - Tool to perform various OSINT techniques on usernames, emails addresses, and domains.
* [sn0int](https://github.com/kpcyrd/sn0int) ⭐ 2,537 | 🐛 55 | 🌐 Rust | 📅 2026-05-15 - Semi-automatic OSINT framework and package manager.
* [SpiderSuite](https://github.com/3nock/SpiderSuite) ⭐ 979 | 🐛 12 | 📅 2026-08-13 - An advance, cross-platform, GUI web security crawler.
* [OsintStalker](https://github.com/milo2012/osintstalker) ⭐ 725 | 🐛 29 | 🌐 Python | 📅 2015-04-03 - Python script for Facebook and geolocation OSINT.
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 716 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively discovers leaked API keys, tokens, secrets, and credentials on any web page by scanning scripts, meta tags, hidden fields, web storage, and network responses using 80+ detection patterns and Shannon entropy analysis.
...
* [Zen](https://github.com/s0md3v/Zen) ⭐ 602 | 🐛 3 | 🌐 Python | 📅 2019-05-05 - Find email addresses of Github users urls and other data effortlessly
...
* [ArkhamMirror](https://github.com/mantisfury/ArkhamMirror) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2026-01-25 - Local-first AI document intelligence with offline RAG, contradiction detection, knowledge graphs, and vision AI table extraction.
* [OpenGraph Intel (OGI)](https://github.com/khashashin/ogi) ⭐ 301 | 🐛 0 | 🌐 Python | 📅 2026-07-24 - Open Source Link Analysis & OSINT Framework. AI Powered Investigation Tool
...
- [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,301 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Free and open source tool for investigating the Dark Web. Its main goal is to help researchers and investigators monitor and track Dark Web sites.
- [Taranis AI](https://github.com/taranis-ai/taranis-ai) ⭐ 1,218 | 🐛 99 | 🌐 Python | 📅 2026-09-18 - Open-source OSINT platform for collecting, enriching, analyzing, and publishing intelligence from web, RSS, email, and other sources with AI/NLP-assisted workflows.
- [VoidAccess](https://github.com/KatrielMoses/voidaccess) ⭐ 733 | 🐛 1 | 🌐 Python | 📅 2026-08-04 - Self-hosted, open-source dark web threat intelligence platform that automates the full OSINT investigation workflow. Supports query refinement, multi-engine Tor search, entity extraction (wallets, CVEs, IPs, actor handles, hashes), relationship graphing, and structured export in STIX 2.1, MISP, Sigma, and CSV. Runs on Docker with free LLMs. MIT licensed.
- [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 236 | 🐛 0 | 📅 2026-09-10 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
- [PhishingSecLists](https://github.com/spmedia/PhishingSecLists) ⭐ 89 | 🐛 0 | 📅 2026-09-11 - This list is to be used with web scanning tools (Gobuster, ffuf, Burp Suite, DirBuster). These lists are specifically tailored and designed for fuzzing phishing, crypto scam landing pages, and other malicious sketch af websites. You can gain vaulable intel on successful hits.
- [ThreatLens](https://github.com/AbdaullahAG/Threat_Intel_Project) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Professional multi-source Threat Intelligence CLI tool to investigate IPs, domains, hashes, and CVEs across multiple free APIs with automated log parsing and color-coded reporting.
...
* [steam\_monitor](https://github.com/misiektoja/steam_monitor) ⭐ 58 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Steam players' gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
* [psn\_monitor](https://github.com/misiektoja/psn_monitor) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Sony Playstation (PSN) players gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
* [xbox\_monitor](https://github.com/misiektoja/xbox_monitor) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Xbox Live players gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
* [lol\_monitor](https://github.com/misiektoja/lol_monitor) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of LoL (League of Legends) players gaming activities including detection when a user starts or finishes a match with support for email alerts, CSV logging, playtime stats and more

## [↑](#-table-of-contents) Music Streaming Services

* [spotify\_monitor](https://github.com/misiektoja/spotify_monitor) ⭐ 107 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Spotify friends' listening activity including detection when user gets online & offline, played songs, its duration, skipped songs, with optional auto-play, email alerts, CSV logging, session stats and more
* [spotify\_profile\_monitor](https://github.com/misiektoja/spotify_profile_monitor) ⭐ 60 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Spotify users' activities and profile changes, including playlists, with support for email alerts, CSV logging, showing media in the terminal, detection of profile picture changes and more
* [lastfm\_monitor](https://github.com/misiektoja/lastfm_monitor) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Tool for real-time tracking of Last.fm users' listening activity including detection when user gets online & offline, pauses or resumes playback, all played songs, its duration, skipped songs, with optional auto-play, email alerts, CSV logging, session stats and more
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,606 | 🐛 10 | 🌐 PHP | 📅 2026-09-19 by @danielmiessler
* [awesome-pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,229 | 🐛 120 | 📅 2026-07-25 by @enaqx
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,351 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 by @Lissy93
* [awesome-hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,091 | 🐛 73 | 📅 2024-06-02 by @carpedm20
* [awesome-security](https://github.com/sbilly/awesome-security) ⭐ 14,867 | 🐛 336 | 📅 2026-01-11 by @sbilly
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,202 | 🐛 25 | 📅 2024-06-07 by @rshipp
* [awesome-ctf](https://github.com/apsdehal/awesome-ctf) ⭐ 11,861 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 by @apsdehal
* [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,656 | 🐛 139 | 📅 2026-05-31 by @hslatman
* [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,565 | 🐛 29 | 🌐 Python | 📅 2026-06-01 by @paralax
* [awesome-privacy](https://github.com/Lissy93/awesome-privacy/) ⭐ 9,881 | 🐛 4 | 🌐 Astro | 📅 2026-09-16 by @Lissy93
* [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,397 | 🐛 83 | 📅 2026-07-15 by @meirwah
* [infosec reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,994 | 🐛 4 | 🌐 CSS | 📅 2025-10-20 by @rmusser01
* [awesome-forensics](https://github.com/Cugu/awesome-forensics) ⭐ 5,186 | 🐛 13 | 📅 2026-09-05 by @cugu
* [awesome-sec-talks](https://github.com/PaulSec/awesome-sec-talks) ⭐ 4,236 | 🐛 0 | 📅 2026-02-17 by @PaulSec
* [awesome-lockpicking](https://github.com/fabacab/awesome-lockpicking) ⭐ 1,929 | 🐛 13 | 📅 2022-06-28 by @fabacab
* [security-list](https://github.com/zbetcheckin/Security_list) ⭐ 1,882 | 🐛 11 | 📅 2022-12-14 by @zbetcheckin
* [awesome-anti-forensic](https://github.com/remiflavien1/awesome-anti-forensic) ⭐ 1,041 | 🐛 6 | 🌐 HTML | 📅 2023-11-27 by @remiflavien1
* [OSINT-BIBLE](https://github.com/frangelbarrera/OSINT-BIBLE) ⭐ 924 | 🐛 3 | 📅 2026-09-13 by @frangelbarrera
