...
[<img src="https://github.com/jivoi/awesome-osint/raw/master/osint_logo.png" align="right" width="100">](https://github.com/jivoi/awesome-osint) ⭐ 29,218 | 🐛 9 | 📅 2026-09-04
...
* [AtDork](https://github.com/amnottdevv/atdork) ⭐ 39 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Professional OSINT dorking tool featuring adaptive delay, circuit breaker, and automatic backend fallback to avoid IP bans and rate limits.
...
* [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 236 | 🐛 0 | 📅 2026-09-07 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,323 | 🐛 884 | 🌐 Python | 📅 2025-08-25 - Osintgram offers an interactive shell to perform analysis on Instagram account of any users by its nickname.
* [Toutatis](https://github.com/megadose/toutatis) ⭐ 4,266 | 🐛 341 | 🌐 Python | 📅 2024-12-05 - a tool that allows you to extract information from instagrams accounts such as s, phone numbers and more
* [instagram\_monitor](https://github.com/misiektoja/instagram_monitor) ⭐ 1,438 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Tool for real-time tracking of Instagram users' activities and profile changes with support for email alerts, CSV logging, showing media in the terminal, anonymous story downloads and more
* [InstagramPrivSniffer](https://github.com/obitouka/InstagramPrivSniffer) ⭐ 995 | 🐛 8 | 🌐 Python | 📅 2026-07-26 - Views Instagram PRIVATE ACCOUNT'S media without login 😱.
* [Osintgraph](https://github.com/XD-MHLOO/Osintgraph) ⭐ 947 | 🐛 11 | 🌐 Python | 📅 2026-05-10 - Tool that maps your target’s Instagram data and relationships in Neo4j for social network analysis.
* [insto](https://github.com/subzeroid/insto) ⭐ 101 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Interactive OSINT CLI / REPL with 35+ slash-commands: profile + media + followers + dossier + geo-fingerprint (`/where`), shared-followers intersection (`/intersect`), superfan ranking (`/fans`), location search (`/place`), URL→metadata resolution (`/postinfo`), posting-cadence histogram (`/timeline`), Maltego CSV export. Token-based (HikerAPI, no IG account needed → no ban risk) with optional logged-in `aiograpi` backend.
...
* [Arctic Shift](https://github.com/ArthurHeitmann/arctic_shift) ⭐ 1,488 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-09 - A tool for accessing and interacting with large dumps of Reddit data, offering an API and web interface for research and moderation purposes.
...
* [OSINT-Steam](https://osint-steam.vercel.app/en) - An [open-source](https://github.com/Berchez/OSINT-steam) ⭐ 27 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 tool that returns public information, such as friends list and possible locations, from Steam profiles.

### [↑](#-table-of-contents) GitHub

* [Shotstars](https://github.com/snooppr/shotstars) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-06-04 - An advanced tool for checking GitHub repositories, with star statistics, including fake star analysis and data visualization.
* [github\_monitor](https://github.com/misiektoja/github_monitor) ⭐ 53 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Tool for real-time tracking of GitHub users' activities including profile and repository changes with support for email alerts, CSV logging, detection when a user blocks or unblocks you and more
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 91,099 | 🐛 340 | 🌐 Python | 📅 2026-09-08 - Search for a username in multiple platforms/websites.
* [Maigret](https://github.com/soxoj/maigret) ⭐ 37,370 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - Collect a dossier on a person by username.
* [Social Analyzer](https://github.com/qeeqbox/social-analyzer) ⭐ 23,961 | 🐛 28 | 🌐 JavaScript | 📅 2026-01-12 - API, CLI, and Web App for analyzing and finding a person's profile in 1000 social media \ websites
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,976 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search a username across over 600+ websites.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,718 | 🐛 11 | 🌐 Python | 📅 2026-09-07 — Check a username's presence across dev/social/gaming/creator site
* [Snoop](https://github.com/snooppr/snoop/blob/master/README.en.md) ⭐ 4,021 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Search for a nickname on the web (OSINT world)
* [NexFil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,616 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - checks username from almost all social network sites.
...
* [Cupidcr4wl](https://github.com/OSINTI4L/cupidcr4wl) ⭐ 168 | 🐛 0 | 🌐 Python | 📅 2026-07-16 - Username and phone number search tool that crawls adult content platforms to see if a targeted account or person is present.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,516 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Investigate Google emails and documents.
* [Holehe](https://github.com/megadose/holehe) ⭐ 14,753 | 🐛 117 | 🌐 Python | 📅 2024-09-10 - allows you to check if the mail is used on different sites like twitter, instagram and will retrieve information on sites with the forgotten password function.
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,976 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search for accounts associated with a given email across various platforms.
* [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,285 | 🐛 39 | 🌐 Python | 📅 2023-08-15 - Password Breach Hunting and Email OSINT, locally or using premium services. Supports chasing down related email.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,718 | 🐛 11 | 🌐 Python | 📅 2026-09-07 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,262 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Free email OSINT tool, checks 800+ platforms, breach exposure via HIBP, infostealer logs via Hudson Rock, and builds a cross-platform identity graph with confidence scoring. `pip install mailaccess`
...
* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,808 | 🐛 138 | 🌐 Go | 📅 2026-08-25 - Advanced information gathering & OSINT framework for phone numbers.
...
* [Crypto Scam & Crypto Phishing URL Threat Intel Feed](https://github.com/spmedia/Crypto-Scam-and-Crypto-Phishing-Threat-Intel-Feed) ⭐ 68 | 🐛 1 | 📅 2026-09-07 - A fresh feed of crypto phishing and crypto scam websites. Automatically updated daily.
...
* [Domain Hunter](https://github.com/WhiteBite/Domain-Hunter) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - Free, open-source, 100% client-side bulk domain availability checker and name generator: checks up to 3,000 names across 148 TLD zones by calling registry RDAP endpoints directly from the browser (no servers, no API keys, no tracking), with DNS-over-HTTPS corroboration for low-trust ccTLDs, live registrar prices with 3-year TCO, and CSV/Markdown export. MIT. ([live demo](https://whitebite.github.io/Domain-Hunter/))
...
* [Wayback-Archive](https://github.com/GeiserX/Wayback-Archive) ⭐ 31 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Download complete websites from the Wayback Machine with full asset preservation for offline viewing.
...
* [ExifLooter](https://github.com/aydinnyunus/exiflooter) ⭐ 498 | 🐛 2 | 🌐 Go | 📅 2026-01-16
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp/) ⭐ 189,783 | 🐛 2,636 | 🌐 Python | 📅 2026-08-30 - Downloads videos from almost any online platform, along with information, thumbnails, subtitles, descriptions, and comments (comments only on a select few sites like Youtube and a few small sites). If a site is not supported, or a useful or crucial piece of metadata, including comments, is missing, create an issue.
* [Video Stabilization Methods](https://github.com/yaochih/awesome-video-stabilization) ⭐ 557 | 🐛 2 | 📅 2025-07-09
...
* [SatIntel](https://github.com/ANG13T/SatIntel) ⭐ 900 | 🐛 5 | 🌐 Go | 📅 2024-03-15
...
* [ChangeDetection.io Open Source](https://github.com/dgtlmoon/changedetection.io) ⭐ 33,717 | 🐛 391 | 🌐 Python | 📅 2026-09-04
...
* [Perspective](https://github.com/finos/perspective) ⭐ 11,173 | 🐛 43 | 🌐 Rust | 📅 2026-09-05 - interactive data visualization and analytics component, well-suited for large, streaming and static datasets.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,412 | 🐛 40 | 🌐 Python | 📅 2026-08-03
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 67,651 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-07
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,122 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - The amass tool searches Internet data sources, performs brute force subdomain enumeration, searches web archives, and uses machine learning to generate additional subdomain name guesses. DNS name resolution is performed across many public servers so the authoritative server will see the traffic coming from different locations. Written in Go.
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,864 | 🐛 18 | 🌐 Go | 📅 2026-09-07 - A fast and multi-purpose DNS toolkit from ProjectDiscovery for running DNS probes, resolving records and filtering DNS responses.
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,907 | 🐛 322 | 🌐 Python | 📅 2026-04-13 - SpiderFoot Github repository.
* [The Harvester](https://github.com/laramies/theHarvester) ⭐ 17,322 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Gather emails, subdomains, hosts, employee names, open ports and banners from different public sources like search engines, PGP key servers and SHODAN computer database.
* [CrowdSec](https://github.com/crowdsecurity/crowdsec) ⭐ 14,792 | 🐛 298 | 🌐 Go | 📅 2026-09-08 - An open source, free, and collaborative IPS/IDS software written in Go, able to analyze visitor behavior & provide an adapted response to all kinds of attacks.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,175 | 🐛 59 | 🌐 Python | 📅 2026-09-04 - Crawler designed for OSINT
* [ReconFTW](https://github.com/six2dez/reconftw) ⭐ 8,074 | 🐛 6 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance framework for bug bounty and pentesting with multiple integrated tools.
...
* [Datasploit](https://github.com/DataSploit/datasploit) ⭐ 3,319 | 🐛 107 | 🌐 Python | 📅 2025-11-20 - Tool to perform various OSINT techniques on usernames, emails addresses, and domains.
* [sn0int](https://github.com/kpcyrd/sn0int) ⭐ 2,528 | 🐛 55 | 🌐 Rust | 📅 2026-05-15 - Semi-automatic OSINT framework and package manager.
* [SpiderSuite](https://github.com/3nock/SpiderSuite) ⭐ 975 | 🐛 12 | 📅 2026-08-13 - An advance, cross-platform, GUI web security crawler.
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 707 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively discovers leaked API keys, tokens, secrets, and credentials on any web page by scanning scripts, meta tags, hidden fields, web storage, and network responses using 80+ detection patterns and Shannon entropy analysis.
* [Cyberbro](https://github.com/stanfrbd/cyberbro) ⭐ 686 | 🐛 38 | 🌐 Python | 📅 2026-08-24 - A self-hosted application, available as a Dockerized, for effortless searching and reputation checking of observables. Extracts IoCs from raw input and check their reputation using multiple services.
...
- [Taranis AI](https://github.com/taranis-ai/taranis-ai) ⭐ 1,212 | 🐛 93 | 🌐 Python | 📅 2026-09-08 - Open-source OSINT platform for collecting, enriching, analyzing, and publishing intelligence from web, RSS, email, and other sources with AI/NLP-assisted workflows.
- [VoidAccess](https://github.com/KatrielMoses/voidaccess) ⭐ 684 | 🐛 6 | 🌐 Python | 📅 2026-08-04 - Self-hosted, open-source dark web threat intelligence platform that automates the full OSINT investigation workflow. Supports query refinement, multi-engine Tor search, entity extraction (wallets, CVEs, IPs, actor handles, hashes), relationship graphing, and structured export in STIX 2.1, MISP, Sigma, and CSV. Runs on Docker with free LLMs. MIT licensed.
- [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 236 | 🐛 0 | 📅 2026-09-07 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
...
* [steam\_monitor](https://github.com/misiektoja/steam_monitor) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Tool for real-time tracking of Steam players' gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
...
* [spotify\_monitor](https://github.com/misiektoja/spotify_monitor) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - Tool for real-time tracking of Spotify friends' listening activity including detection when user gets online & offline, played songs, its duration, skipped songs, with optional auto-play, email alerts, CSV logging, session stats and more
* [spotify\_profile\_monitor](https://github.com/misiektoja/spotify_profile_monitor) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Tool for real-time tracking of Spotify users' activities and profile changes, including playlists, with support for email alerts, CSV logging, showing media in the terminal, detection of profile picture changes and more
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,367 | 🐛 14 | 🌐 PHP | 📅 2026-09-08 by @danielmiessler
* [awesome-pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,143 | 🐛 116 | 📅 2026-07-25 by @enaqx
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,283 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 by @Lissy93
* [awesome-hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,017 | 🐛 72 | 📅 2024-06-02 by @carpedm20
* [awesome-security](https://github.com/sbilly/awesome-security) ⭐ 14,841 | 🐛 322 | 📅 2026-01-11 by @sbilly
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,182 | 🐛 25 | 📅 2024-06-07 by @rshipp
* [awesome-ctf](https://github.com/apsdehal/awesome-ctf) ⭐ 11,835 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 by @apsdehal
* [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,607 | 🐛 122 | 📅 2026-05-31 by @hslatman
* [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,548 | 🐛 22 | 🌐 Python | 📅 2026-06-01 by @paralax
* [awesome-privacy](https://github.com/Lissy93/awesome-privacy/) ⭐ 9,851 | 🐛 3 | 🌐 Astro | 📅 2026-09-07 by @Lissy93
* [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,376 | 🐛 79 | 📅 2026-07-15 by @meirwah
* [infosec reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,989 | 🐛 4 | 🌐 CSS | 📅 2025-10-20 by @rmusser01
* [awesome-forensics](https://github.com/Cugu/awesome-forensics) ⭐ 5,179 | 🐛 10 | 📅 2026-09-05 by @cugu
...
* [security-list](https://github.com/zbetcheckin/Security_list) ⭐ 1,882 | 🐛 11 | 📅 2022-12-14 by @zbetcheckin
* [awesome-anti-forensic](https://github.com/remiflavien1/awesome-anti-forensic) ⭐ 1,036 | 🐛 6 | 🌐 HTML | 📅 2023-11-27 by @remiflavien1
* [OSINT-BIBLE](https://github.com/frangelbarrera/OSINT-BIBLE) ⭐ 907 | 🐛 3 | 📅 2026-09-01 by @frangelbarrera
