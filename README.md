...
[<img src="https://github.com/jivoi/awesome-osint/raw/master/osint_logo.png" align="right" width="100">](https://github.com/jivoi/awesome-osint) ⭐ 28,091 | 🐛 12 | 📅 2026-08-03
...
* [AtDork](https://github.com/amnottdevv/atdork) ⭐ 36 | 🐛 5 | 🌐 Python | 📅 2026-08-10 - Professional OSINT dorking tool featuring adaptive delay, circuit breaker, and automatic backend fallback to avoid IP bans and rate limits.
* [DorkCraft](https://github.com/juandresrodca/DorkCraft) ⭐ 4 | 🐛 0 | 🌐 Astro | 📅 2026-05-16 - Google dork generator that builds advanced search queries for OSINT and reconnaissance.
...
* [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 230 | 🐛 0 | 📅 2026-08-10 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
...
* [Fb-sleep-stats](https://github.com/sqren/fb-sleep-stats) ⭐ 1,704 | 🐛 49 | 🌐 JavaScript | 📅 2020-09-29 - Use Facebook to track your friends’ sleeping habits.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 13,994 | 🐛 884 | 🌐 Python | 📅 2025-08-25 - Osintgram offers an interactive shell to perform analysis on Instagram account of any users by its nickname.
* [Toutatis](https://github.com/megadose/toutatis) ⭐ 4,183 | 🐛 328 | 🌐 Python | 📅 2024-12-05 - a tool that allows you to extract information from instagrams accounts such as s, phone numbers and more
* [instagram\_monitor](https://github.com/misiektoja/instagram_monitor) ⭐ 1,264 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Tool for real-time tracking of Instagram users' activities and profile changes with support for email alerts, CSV logging, showing media in the terminal, anonymous story downloads and more
* [InstagramPrivSniffer](https://github.com/obitouka/InstagramPrivSniffer) ⭐ 960 | 🐛 6 | 🌐 Python | 📅 2026-07-26 - Views Instagram PRIVATE ACCOUNT'S media without login 😱.
* [Osintgraph](https://github.com/XD-MHLOO/Osintgraph) ⭐ 893 | 🐛 11 | 🌐 Python | 📅 2026-05-10 - Tool that maps your target’s Instagram data and relationships in Neo4j for social network analysis.
* [insto](https://github.com/subzeroid/insto) ⭐ 88 | 🐛 1 | 🌐 Python | 📅 2026-06-20 - Interactive OSINT CLI / REPL with 35+ slash-commands: profile + media + followers + dossier + geo-fingerprint (`/where`), shared-followers intersection (`/intersect`), superfan ranking (`/fans`), location search (`/place`), URL→metadata resolution (`/postinfo`), posting-cadence histogram (`/timeline`), Maltego CSV export. Token-based (HikerAPI, no IG account needed → no ban risk) with optional logged-in `aiograpi` backend.
...
* [Arctic Shift](https://github.com/ArthurHeitmann/arctic_shift) ⭐ 1,371 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-09 - A tool for accessing and interacting with large dumps of Reddit data, offering an API and web interface for research and moderation purposes.
...
* [LinkedInDumper](https://github.com/l4rm4nd/LinkedInDumper) ⭐ 607 | 🐛 0 | 🌐 Python | 📅 2026-08-07 - Script to dump/scrape/extract company employees info from LinkedIn API.
...
* [Telerecon](https://github.com/sockysec/Telerecon) ⭐ 1,322 | 🐛 7 | 🌐 Python | 📅 2024-07-11 - A reconnaissance framework for researching and investigating Telegram.
...
* [TeleTracker](https://github.com/tsale/TeleTracker) ⭐ 538 | 🐛 7 | 🌐 Python | 📅 2024-06-15 - TeleTracker is a simple set of Python scripts designed for anyone investigating Telegram channels. It helps you send messages quickly and gather useful channel information easily.
...
* [Steam-OSINT](https://github.com/matiash26/steam-osint) ⭐ 95 | 🐛 0 | 🌐 Python | 📅 2026-07-01 - Open-source OSINT tool for accurate mutual friends analysis on Steam, supporting full friend lists.

* [OSINT-Steam](https://osint-steam.vercel.app/en) - An [open-source](https://github.com/Berchez/OSINT-steam) ⭐ 26 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-14 tool that returns public information, such as friends list and possible locations, from Steam profiles.
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 89,521 | 🐛 325 | 🌐 Python | 📅 2026-08-15 - Search for a username in multiple platforms/websites.
* [Maigret](https://github.com/soxoj/maigret) ⭐ 36,770 | 🐛 17 | 🌐 Python | 📅 2026-08-14 - Collect a dossier on a person by username.
* [Social Analyzer](https://github.com/qeeqbox/social-analyzer) ⭐ 23,759 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-12 - API, CLI, and Web App for analyzing and finding a person's profile in 1000 social media \ websites
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,568 | 🐛 17 | 🌐 Python | 📅 2025-07-13 - Search a username across over 600+ websites.
* [Snoop](https://github.com/snooppr/snoop/blob/master/README.en.md) ⭐ 4,002 | 🐛 1 | 🌐 Python | 📅 2026-07-30 - Search for a nickname on the web (OSINT world)
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 3,193 | 🐛 12 | 🌐 Python | 📅 2026-08-14 — Check a username's presence across dev/social/gaming/creator site
* [NexFil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,604 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - checks username from almost all social network sites.
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 853 | 🐛 65 | 🌐 Go | 📅 2026-06-16 A multi-purpose all in one toolkit for gathering and managing OSINT-Data with a neat web-interface. Can be used for note taking and username checking.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,360 | 🐛 72 | 🌐 Python | 📅 2026-04-10 - Investigate Google emails and documents.
* [Holehe](https://github.com/megadose/holehe) ⭐ 12,926 | 🐛 102 | 🌐 Python | 📅 2024-09-10 - allows you to check if the mail is used on different sites like twitter, instagram and will retrieve information on sites with the forgotten password function.
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,568 | 🐛 17 | 🌐 Python | 📅 2025-07-13 - Search for accounts associated with a given email across various platforms.
* [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,250 | 🐛 39 | 🌐 Python | 📅 2023-08-15 - Password Breach Hunting and Email OSINT, locally or using premium services. Supports chasing down related email.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 3,193 | 🐛 12 | 🌐 Python | 📅 2026-08-14 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 473 | 🐛 1 | 🌐 Python | 📅 2026-08-05 - Free email OSINT tool, checks 800+ platforms, breach exposure via HIBP, infostealer logs via Hudson Rock, and builds a cross-platform identity graph with confidence scoring. `pip install mailaccess`
...
* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,499 | 🐛 118 | 🌐 Go | 📅 2026-01-06 - Advanced information gathering & OSINT framework for phone numbers.
...
* [Crypto Scam & Crypto Phishing URL Threat Intel Feed](https://github.com/spmedia/Crypto-Scam-and-Crypto-Phishing-Threat-Intel-Feed) ⭐ 65 | 🐛 1 | 📅 2026-08-11 - A fresh feed of crypto phishing and crypto scam websites. Automatically updated daily.
...
* [waybackpy](https://github.com/akamhy/waybackpy) ⭐ 602 | 🐛 21 | 🌐 Python | 📅 2024-02-26 - Python package & CLI tool that interfaces the Wayback Machine APIs.
...
* [GeoSpyer](https://github.com/atiilla/geospy "Original service: https://geospy.web.app/") ⭐ 1,126 | 🐛 2 | 🌐 HTML | 📅 2026-03-09 - Python tool using Graylark's AI-powered geo-location service to uncover the location where photos were taken.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp/) ⭐ 184,523 | 🐛 2,610 | 🌐 Python | 📅 2026-08-04 - Downloads videos from almost any online platform, along with information, thumbnails, subtitles, descriptions, and comments (comments only on a select few sites like Youtube and a few small sites). If a site is not supported, or a useful or crucial piece of metadata, including comments, is missing, create an issue.
...
* [Hyperlapse](https://github.com/TeehanLax/Hyperlapse.js) ⭐ 2,470 | 🐛 27 | 🌐 JavaScript | 📅 2020-02-29
...
* [ChangeDetection.io Open Source](https://github.com/dgtlmoon/changedetection.io) ⭐ 33,144 | 🐛 380 | 🌐 Python | 📅 2026-08-07
* [Website-Diff](https://github.com/GeiserX/Website-Diff) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-01
...
* [Perspective](https://github.com/finos/perspective) ⭐ 11,110 | 🐛 59 | 🌐 Rust | 📅 2026-08-10 - interactive data visualization and analytics component, well-suited for large, streaming and static datasets.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 36 | 🌐 Python | 📅 2026-08-03
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 66,979 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-14
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 14,982 | 🐛 236 | 🌐 Go | 📅 2026-07-19 - The amass tool searches Internet data sources, performs brute force subdomain enumeration, searches web archives, and uses machine learning to generate additional subdomain name guesses. DNS name resolution is performed across many public servers so the authoritative server will see the traffic coming from different locations. Written in Go.
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,838 | 🐛 5 | 🌐 Go | 📅 2026-08-10 - A fast and multi-purpose DNS toolkit from ProjectDiscovery for running DNS probes, resolving records and filtering DNS responses.
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,011 | 🐛 297 | 🌐 Python | 📅 2026-04-13 - SpiderFoot Github repository.
* [The Harvester](https://github.com/laramies/theHarvester) ⭐ 17,055 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - Gather emails, subdomains, hosts, employee names, open ports and banners from different public sources like search engines, PGP key servers and SHODAN computer database.
* [CrowdSec](https://github.com/crowdsecurity/crowdsec) ⭐ 14,522 | 🐛 284 | 🌐 Go | 📅 2026-08-14 - An open source, free, and collaborative IPS/IDS software written in Go, able to analyze visitor behavior & provide an adapted response to all kinds of attacks.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,112 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Crawler designed for OSINT
* [ReconFTW](https://github.com/six2dez/reconftw) ⭐ 7,982 | 🐛 3 | 🌐 Shell | 📅 2026-08-12 - Automated reconnaissance framework for bug bounty and pentesting with multiple integrated tools.
* [Waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,537 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all URLs known by the Wayback Machine for a domain.
...
* [Cyberbro](https://github.com/stanfrbd/cyberbro) ⭐ 681 | 🐛 31 | 🌐 Python | 📅 2026-08-10 - A self-hosted application, available as a Dockerized, for effortless searching and reputation checking of observables. Extracts IoCs from raw input and check their reputation using multiple services.
...
* [ArkhamMirror](https://github.com/mantisfury/ArkhamMirror) ⭐ 483 | 🐛 0 | 🌐 Python | 📅 2026-01-25 - Local-first AI document intelligence with offline RAG, contradiction detection, knowledge graphs, and vision AI table extraction.
...
* [Dehashed CLI](https://github.com/hmaverickadams/DeHashed-API-Tool) ⭐ 277 | 🐛 5 | 🌐 Python | 📅 2025-07-02 - Command-line tool for searching breach databases via DeHashed API.
* [PRISM](https://github.com/NovaCode37/Prism-platform) ⭐ 177 | 🐛 10 | 🌐 Python | 📅 2026-08-14 - Self-hosted all-in-one OSINT platform that scans a domain, IP, email, phone, or username across 22+ modules and returns threat intel, breach data, subdomains, an OPSEC score, entity graph, GeoIP map, and HTML/PDF reports. [Live demo](https://getprism.su).
...
* [IntellyWeave](https://github.com/vericle/intellyweave) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-01-12  - AI-powered OSINT platform with GLiNER entity extraction, Mapbox 3D geospatial visualization, and multi-agent archive research across 30+ international archives.
...
- [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,278 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Free and open source tool for investigating the Dark Web. Its main goal is to help researchers and investigators monitor and track Dark Web sites.
- [Taranis AI](https://github.com/taranis-ai/taranis-ai) ⭐ 1,203 | 🐛 100 | 🌐 Python | 📅 2026-08-14 - Open-source OSINT platform for collecting, enriching, analyzing, and publishing intelligence from web, RSS, email, and other sources with AI/NLP-assisted workflows.
- [VoidAccess](https://github.com/KatrielMoses/voidaccess) ⭐ 612 | 🐛 6 | 🌐 Python | 📅 2026-08-04 - Self-hosted, open-source dark web threat intelligence platform that automates the full OSINT investigation workflow. Supports query refinement, multi-engine Tor search, entity extraction (wallets, CVEs, IPs, actor handles, hashes), relationship graphing, and structured export in STIX 2.1, MISP, Sigma, and CSV. Runs on Docker with free LLMs. MIT licensed.
- [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 230 | 🐛 0 | 📅 2026-08-10 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
- [PhishingSecLists](https://github.com/spmedia/PhishingSecLists) ⭐ 87 | 🐛 0 | 📅 2026-08-05 - This list is to be used with web scanning tools (Gobuster, ffuf, Burp Suite, DirBuster). These lists are specifically tailored and designed for fuzzing phishing, crypto scam landing pages, and other malicious sketch af websites. You can gain vaulable intel on successful hits.
...
* [steam\_monitor](https://github.com/misiektoja/steam_monitor) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - Tool for real-time tracking of Steam players' gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 72,853 | 🐛 12 | 🌐 PHP | 📅 2026-08-14 by @danielmiessler
* [awesome-pentest](https://github.com/enaqx/awesome-pentest) ⭐ 26,902 | 🐛 98 | 📅 2026-07-25 by @enaqx
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,087 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-28 by @Lissy93
* [awesome-hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,871 | 🐛 68 | 📅 2024-06-02 by @carpedm20
* [awesome-security](https://github.com/sbilly/awesome-security) ⭐ 14,748 | 🐛 305 | 📅 2026-01-11 by @sbilly
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,120 | 🐛 25 | 📅 2024-06-07 by @rshipp
* [awesome-ctf](https://github.com/apsdehal/awesome-ctf) ⭐ 11,754 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 by @apsdehal
* [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,534 | 🐛 116 | 📅 2026-05-31 by @hslatman
* [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,521 | 🐛 21 | 🌐 Python | 📅 2026-06-01 by @paralax
* [awesome-privacy](https://github.com/Lissy93/awesome-privacy/) ⭐ 9,735 | 🐛 3 | 🌐 Astro | 📅 2026-08-15 by @Lissy93
* [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,326 | 🐛 73 | 📅 2026-07-15 by @meirwah
* [infosec reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,984 | 🐛 2 | 🌐 CSS | 📅 2025-10-20 by @rmusser01
* [awesome-forensics](https://github.com/Cugu/awesome-forensics) ⭐ 5,159 | 🐛 5 | 📅 2026-05-14 by @cugu
* [awesome-sec-talks](https://github.com/PaulSec/awesome-sec-talks) ⭐ 4,228 | 🐛 0 | 📅 2026-02-17 by @PaulSec
* [awesome-lockpicking](https://github.com/fabacab/awesome-lockpicking) ⭐ 1,913 | 🐛 13 | 📅 2022-06-28 by @fabacab
* [security-list](https://github.com/zbetcheckin/Security_list) ⭐ 1,880 | 🐛 11 | 📅 2022-12-14 by @zbetcheckin
* [awesome-anti-forensic](https://github.com/remiflavien1/awesome-anti-forensic) ⭐ 1,027 | 🐛 4 | 🌐 HTML | 📅 2023-11-27 by @remiflavien1
* [OSINT-BIBLE](https://github.com/frangelbarrera/OSINT-BIBLE) ⭐ 856 | 🐛 4 | 📅 2026-08-09 by @frangelbarrera
