...
[<img src="https://github.com/jivoi/awesome-osint/raw/master/osint_logo.png" align="right" width="100">](https://github.com/jivoi/awesome-osint) ⭐ 29,571 | 🐛 18 | 📅 2026-09-09
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,420 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram offers an interactive shell to perform analysis on Instagram account of any users by its nickname.
* [Toutatis](https://github.com/megadose/toutatis) ⭐ 4,286 | 🐛 346 | 🌐 Python | 📅 2024-12-05 - a tool that allows you to extract information from instagrams accounts such as s, phone numbers and more
* [instagram\_monitor](https://github.com/misiektoja/instagram_monitor) ⭐ 1,495 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - Tool for real-time tracking of Instagram users' activities and profile changes with support for email alerts, CSV logging, showing media in the terminal, anonymous story downloads and more
* [InstagramPrivSniffer](https://github.com/obitouka/InstagramPrivSniffer) ⭐ 1,008 | 🐛 8 | 🌐 Python | 📅 2026-07-26 - Views Instagram PRIVATE ACCOUNT'S media without login 😱.
* [Osintgraph](https://github.com/XD-MHLOO/Osintgraph) ⭐ 956 | 🐛 11 | 🌐 Python | 📅 2026-05-10 - Tool that maps your target’s Instagram data and relationships in Neo4j for social network analysis.
* [insto](https://github.com/subzeroid/insto) ⭐ 112 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Interactive OSINT CLI / REPL with 35+ slash-commands: profile + media + followers + dossier + geo-fingerprint (`/where`), shared-followers intersection (`/intersect`), superfan ranking (`/fans`), location search (`/place`), URL→metadata resolution (`/postinfo`), posting-cadence histogram (`/timeline`), Maltego CSV export. Token-based (HikerAPI, no IG account needed → no ban risk) with optional logged-in `aiograpi` backend.
...
* [Arctic Shift](https://github.com/ArthurHeitmann/arctic_shift) ⭐ 1,525 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-12 - A tool for accessing and interacting with large dumps of Reddit data, offering an API and web interface for research and moderation purposes.
...
* [OSINT-Steam](https://osint-steam.vercel.app/en) - An [open-source](https://github.com/Berchez/OSINT-steam) ⭐ 27 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-15 tool that returns public information, such as friends list and possible locations, from Steam profiles.
...
* [github\_monitor](https://github.com/misiektoja/github_monitor) ⭐ 54 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Tool for real-time tracking of GitHub users' activities including profile and repository changes with support for email alerts, CSV logging, detection when a user blocks or unblocks you and more
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 91,704 | 🐛 346 | 🌐 Python | 📅 2026-09-16 - Search for a username in multiple platforms/websites.
* [Maigret](https://github.com/soxoj/maigret) ⭐ 37,624 | 🐛 63 | 🌐 Python | 📅 2026-09-16 - Collect a dossier on a person by username.
* [Social Analyzer](https://github.com/qeeqbox/social-analyzer) ⭐ 24,046 | 🐛 28 | 🌐 JavaScript | 📅 2026-01-12 - API, CLI, and Web App for analyzing and finding a person's profile in 1000 social media \ websites
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,201 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search a username across over 600+ websites.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,804 | 🐛 10 | 🌐 Python | 📅 2026-09-16 — Check a username's presence across dev/social/gaming/creator site
...
* [Cupidcr4wl](https://github.com/OSINTI4L/cupidcr4wl) ⭐ 172 | 🐛 0 | 🌐 Python | 📅 2026-07-16 - Username and phone number search tool that crawls adult content platforms to see if a targeted account or person is present.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,568 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Investigate Google emails and documents.
* [Holehe](https://github.com/megadose/holehe) ⭐ 14,925 | 🐛 117 | 🌐 Python | 📅 2024-09-10 - allows you to check if the mail is used on different sites like twitter, instagram and will retrieve information on sites with the forgotten password function.
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,201 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - Search for accounts associated with a given email across various platforms.
* [h8mail](https://github.com/khast3x/h8mail) ⭐ 5,305 | 🐛 39 | 🌐 Python | 📅 2023-08-15 - Password Breach Hunting and Email OSINT, locally or using premium services. Supports chasing down related email.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,804 | 🐛 10 | 🌐 Python | 📅 2026-09-16 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,378 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Free email OSINT tool, checks 800+ platforms, breach exposure via HIBP, infostealer logs via Hudson Rock, and builds a cross-platform identity graph with confidence scoring. `pip install mailaccess`
...
* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,883 | 🐛 142 | 🌐 Go | 📅 2026-08-25 - Advanced information gathering & OSINT framework for phone numbers.
...
* [Crypto Scam & Crypto Phishing URL Threat Intel Feed](https://github.com/spmedia/Crypto-Scam-and-Crypto-Phishing-Threat-Intel-Feed) ⭐ 69 | 🐛 1 | 📅 2026-09-15 - A fresh feed of crypto phishing and crypto scam websites. Automatically updated daily.
...
* [Domain Hunter](https://github.com/WhiteBite/Domain-Hunter) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - Free, open-source, 100% client-side bulk domain availability checker and name generator: checks up to 3,000 names across 148 TLD zones by calling registry RDAP endpoints directly from the browser (no servers, no API keys, no tracking), with DNS-over-HTTPS corroboration for low-trust ccTLDs, live registrar prices with 3-year TCO, and CSV/Markdown export. MIT. ([live demo](https://whitebite.github.io/Domain-Hunter/))
...
* [GeoSpyer](https://github.com/atiilla/geospy "Original service: https://geospy.web.app/") ⭐ 1,133 | 🐛 2 | 🌐 HTML | 📅 2026-03-09 - Python tool using Graylark's AI-powered geo-location service to uncover the location where photos were taken.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp/) ⭐ 191,534 | 🐛 2,652 | 🌐 Python | 📅 2026-09-16 - Downloads videos from almost any online platform, along with information, thumbnails, subtitles, descriptions, and comments (comments only on a select few sites like Youtube and a few small sites). If a site is not supported, or a useful or crucial piece of metadata, including comments, is missing, create an issue.
...
* [ChangeDetection.io Open Source](https://github.com/dgtlmoon/changedetection.io) ⭐ 34,309 | 🐛 383 | 🌐 Python | 📅 2026-09-16
...
* [Perspective](https://github.com/finos/perspective) ⭐ 11,215 | 🐛 38 | 🌐 Rust | 📅 2026-09-16 - interactive data visualization and analytics component, well-suited for large, streaming and static datasets.
* [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,410 | 🐛 43 | 🌐 Python | 📅 2026-08-03
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 67,885 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14
* [MetaClean](https://github.com/Moresyl/metaclean) ⭐ 14 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Cross-platform desktop app for removing sensitive metadata from files locally before sharing them during OSINT investigations.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,169 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - The amass tool searches Internet data sources, performs brute force subdomain enumeration, searches web archives, and uses machine learning to generate additional subdomain name guesses. DNS name resolution is performed across many public servers so the authoritative server will see the traffic coming from different locations. Written in Go.
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,869 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - A fast and multi-purpose DNS toolkit from ProjectDiscovery for running DNS probes, resolving records and filtering DNS responses.
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,190 | 🐛 318 | 🌐 Python | 📅 2026-04-13 - SpiderFoot Github repository.
* [The Harvester](https://github.com/laramies/theHarvester) ⭐ 17,445 | 🐛 7 | 🌐 Python | 📅 2026-09-10 - Gather emails, subdomains, hosts, employee names, open ports and banners from different public sources like search engines, PGP key servers and SHODAN computer database.
* [CrowdSec](https://github.com/crowdsecurity/crowdsec) ⭐ 14,866 | 🐛 292 | 🌐 Go | 📅 2026-09-16 - An open source, free, and collaborative IPS/IDS software written in Go, able to analyze visitor behavior & provide an adapted response to all kinds of attacks.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,209 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Crawler designed for OSINT
* [ReconFTW](https://github.com/six2dez/reconftw) ⭐ 8,113 | 🐛 7 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance framework for bug bounty and pentesting with multiple integrated tools.
...
* [OpenGraph Intel (OGI)](https://github.com/khashashin/ogi) ⭐ 299 | 🐛 0 | 🌐 Python | 📅 2026-07-24 - Open Source Link Analysis & OSINT Framework. AI Powered Investigation Tool
...
- [Taranis AI](https://github.com/taranis-ai/taranis-ai) ⭐ 1,218 | 🐛 87 | 🌐 Python | 📅 2026-09-16 - Open-source OSINT platform for collecting, enriching, analyzing, and publishing intelligence from web, RSS, email, and other sources with AI/NLP-assisted workflows.
- [VoidAccess](https://github.com/KatrielMoses/voidaccess) ⭐ 727 | 🐛 1 | 🌐 Python | 📅 2026-08-04 - Self-hosted, open-source dark web threat intelligence platform that automates the full OSINT investigation workflow. Supports query refinement, multi-engine Tor search, entity extraction (wallets, CVEs, IPs, actor handles, hashes), relationship graphing, and structured export in STIX 2.1, MISP, Sigma, and CSV. Runs on Docker with free LLMs. MIT licensed.
- [Threat Actor Usernames Scrape](https://github.com/spmedia/Threat-Actor-Usernames-Scrape) ⭐ 236 | 🐛 0 | 📅 2026-09-10 - A collection of fresh intel and 900k+ threat actor usernames scraped from various cybercrime sources & forums.
...
- [ThreatLens](https://github.com/AbdaullahAG/Threat_Intel_Project) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Professional multi-source Threat Intelligence CLI tool to investigate IPs, domains, hashes, and CVEs across multiple free APIs with automated log parsing and color-coded reporting.
...
* [psn\_monitor](https://github.com/misiektoja/psn_monitor) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - Tool for real-time tracking of Sony Playstation (PSN) players gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
* [xbox\_monitor](https://github.com/misiektoja/xbox_monitor) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Tool for real-time tracking of Xbox Live players gaming activities including detection when a user gets online/offline or plays games with support for email alerts, CSV logging, playtime stats and more
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,550 | 🐛 8 | 🌐 PHP | 📅 2026-09-16 by @danielmiessler
* [awesome-pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,205 | 🐛 119 | 📅 2026-07-25 by @enaqx
* [personal-security-checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,329 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 by @Lissy93
* [awesome-hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,075 | 🐛 73 | 📅 2024-06-02 by @carpedm20
* [awesome-security](https://github.com/sbilly/awesome-security) ⭐ 14,860 | 🐛 331 | 📅 2026-01-11 by @sbilly
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,199 | 🐛 25 | 📅 2024-06-07 by @rshipp
* [awesome-ctf](https://github.com/apsdehal/awesome-ctf) ⭐ 11,854 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 by @apsdehal
* [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,644 | 🐛 138 | 📅 2026-05-31 by @hslatman
* [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,563 | 🐛 26 | 🌐 Python | 📅 2026-06-01 by @paralax
* [awesome-privacy](https://github.com/Lissy93/awesome-privacy/) ⭐ 9,877 | 🐛 3 | 🌐 Astro | 📅 2026-09-12 by @Lissy93
* [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,390 | 🐛 82 | 📅 2026-07-15 by @meirwah
...
* [OSINT-BIBLE](https://github.com/frangelbarrera/OSINT-BIBLE) ⭐ 918 | 🐛 1 | 📅 2026-09-13 by @frangelbarrera
